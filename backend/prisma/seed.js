...
async function main() {
        ...
        data: [
            {
                ...
                details: { description: 'Database seeded for hackathon demo' },
            },
        ],
        skipDuplicates: true,
    });
    ...
    console.log('');
    console.log(`  Demo Patients: ${patient1.mrn} (${patient1.name}), ${patient2.mrn} (${patient2.name})`);
